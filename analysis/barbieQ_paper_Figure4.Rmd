...
# Plot barcode proportion and sample annotation
...
DDDDDEEEE
"
f4 <- (wrap_elements(f4a + theme(plot.margin = unit(rep(0,4), "cm")), full = grob) + 
    wrap_elements(f4b + theme(plot.margin = unit(rep(0,4), "cm"))) + 
    wrap_elements(f4c + theme(plot.margin = unit(c(1,0,1,0), "cm"))) +
    wrap_elements(f4d + theme(plot.margin = unit(rep(0,4), "cm"))) +
    wrap_elements(f4e + theme(plot.margin = unit(rep(0,4), "cm")))
    )+ 
...
f4g <- venn_top10each_feature %>% plot() %>% grid.grabExpr() %>% wrap_plots()

f4g
```

## inspect two sets: boxplot
...
f4 <- (wrap_elements(full = f4a) + 
    wrap_elements(f4b + theme(plot.margin = unit(rep(0,4), "cm"))) + 
    wrap_elements(f4c + theme(plot.margin = unit(c(2,2,2,2), "cm"))) +
    wrap_elements(f4d + theme(plot.margin = unit(rep(0,4), "cm"))) +
    wrap_plots(list(f4e %>% draw() %>% grid.grabExpr())) +
    wrap_elements(f4f + theme(plot.margin = unit(rep(0,4), "cm"))) + 
    wrap_elements(f4g + theme(plot.margin = unit(rep(0,4), "cm"))) + 
